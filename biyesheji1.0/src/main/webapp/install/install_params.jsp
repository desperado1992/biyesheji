...
<title>系统参数设置--二手商品交易平台安装向导</title>
		  ...
		  <table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td align="left"><input name="dbPassword" type="text"
					class="input" id="dbPassword" value="123456"/></td>
...
<input type="hidden" name="dbFileName"
	value="/install/db/db.sql" /> <input type="hidden"
	name="initFileName" value="/install/db/shop.sql" />
</form>
</body>
</html>
