...
<!DOCTYPE html>
<html>
<title>即时在线聊天工具版</title>
<!-- 加载AnyChat for Web SDK库  -->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/resources/chat/javascript/anychatsdk.js" ></script>
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/resources/chat/javascript/anychatevent.js" ></script>
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/resources/chat/javascript/advanceset.js" ></script>
<!-- 加载业务逻辑控制脚本  -->
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/resources/chat/javascript/logicfunc.js" ></script>
<link href="${pageContext.request.contextPath}/resources/chat/css/demo.css" rel="stylesheet" type="text/css" />	
<link href="${pageContext.request.contextPath}/resources/chat/css/advanceset.css" rel="Stylesheet" type="text/css" />
...
<!--操作等待层 -->
<div id="LOADING_DIV"><img src="${pageContext.request.contextPath}/resources/chat/images/LoadImg.gif" alt="请等待..." style=" height:50px;" /></div>
...
<div id="MAIN_DIV">
    ...
    <div id="prompt_div">
        ...
        <div style="height: 85px;">
            <div id="prompt_div_BR">
                <a href="">即时聊天简单工具版</a>&nbsp|&nbsp WEBRTC</a>
            </div>
        </div>
    </div>
    ...
    <div id="login_div">
        ...
        <div style=" height:35px; line-height:35px; text-align:left; margin:10px 5px 0px 5px; text-align:center;">欢迎${sessionScope.user.logName}进入聊天室</div>
            <div id="cutoff_div"></div>
        </div>
        <div class="wordage">当前用户名为：<input type="text" id="username"  value="${sessionScope.user.name}"/><a id="a_error_user" style=" color:#FAFADD; font-size:15px;">&nbsp×</a></div>
    ...
    <div id="hall_div">
        ...
        <div id="hall_div_myinfo">
            ...
            <div id="hall_div_table">
                ...
                <div class="hall_div_table_room" id="hall_div_table_room<s:property value="#status.index"/>" onmouseout="Mouseout('hall_div_table_room<s:property value="#status.index"/>')" onmousemove="Mouseover('hall_div_table_room<s:property value="#status.index"/>')" onclick="EnterRoomRequest(<s:property value="#status.index"/>+1)">${name}</div>
