...
<s:form action="roleAction!%{id == null ? 'add' : 'edit'}"  id="shopform" >
<div class="heading-buttons">
	<h2 class="glyphicons cart_in"><i></i> 商品品牌添加</h2>
...
<div class="widget widget-2 widget-tabs">
	<div class="widget-head">
		<ul>
			<li class="active"><a href="#productDescriptionTab" data-toggle="tab" class="glyphicons font"><i></i>角色管理</a></li>
		...
		<s:hidden name="id"></s:hidden>
			...
			<div class="tab-pane active" id="productDescriptionTab">
				<div class="row-fluid">
					<div class="span3">
						<strong>用户角色</strong>
						<p class="muted">角色名称.</p>
					</div>
					<div class="span9">
						<label for="inputEmail">角色字段名</label>
						<input type="text" id="" class="span6" name="name" value="${name}" placeholder="请输入角色名称" />
						<div class="separator"></div>
					</div>
				</div>
				...
				<div class="row-fluid">
					<div class="span3">
						<strong>角色介绍</strong>
						<p class="muted">角色的介绍说明.</p>
					</div>
					<div class="span9">
						<label for="inputEmail">角色说明</label>
