...
<div class="heading-buttons">
	<h2 class="glyphicons shopping_cart"><i></i> 品牌列表</h2>
	<div class="buttons pull-right">
		<a href="${pageContext.request.contextPath}/main/frendLinkAction!addUI.action" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> 添     加  </a>
		...
		<div class="widget widget-2">
			...
			<div class="widget-body">
				...
				<table class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable">
					...
					<tbody>
					<s:iterator value="frendlinks" status="stats">
																		<tr class="selectable">
							...
							<td class="center important"><span class="glyphicons btn-action single " style="margin-right: 0;"><i></i></span><a href="${url}" target="_blank">${url}</a></td>
							
							<td class="center">
								<a href="${pageContext.request.contextPath}/main/frendLinkAction!editUI.action?id=${id}" class="btn-action glyphicons pencil btn-success"><i></i></a>
								<a href="${pageContext.request.contextPath}/main/frendLinkAction!delete.action?id=${id}"  onclick="return window.confirm('您确定要删除当前友情链接吗？')"  class="btn-action glyphicons remove_2 btn-danger"><i></i></a>
							</td>
						</tr>
						</s:iterator>					
