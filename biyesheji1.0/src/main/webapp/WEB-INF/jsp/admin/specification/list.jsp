...
<div class="heading-buttons">
	<h2 class="glyphicons shopping_cart"><i></i> 商品规格管理</h2>
	<div class="buttons pull-right">
		<a href="${pageContext.request.contextPath}/main/specificationAction!addUI.action" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> 添     加  </a>
		...
		<div class="widget widget-2">
			...
			<div class="widget-body">
				...
				<table class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable">
					...
					<tbody>
						<s:iterator value="specifications" status="stats">
							...
							<td class="center">${measures}</td>
							<td class="center">${color}</td>
							
							
							<td class="center">
								<a href="${pageContext.request.contextPath}/main/specificationAction!editUI.action?id=${id}" class="btn-action glyphicons pencil btn-success"><i></i></a>
								<a href="${pageContext.request.contextPath}/main/specificationAction!delete.action?id=${id}"  onclick="return window.confirm('您确定要删除当前选中商品规格吗？')" class="btn-action glyphicons remove_2 btn-danger"><i></i></a>
