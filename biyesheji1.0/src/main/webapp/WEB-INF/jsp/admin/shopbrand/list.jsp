...
<div class="heading-buttons">
	...
	<div class="buttons pull-right">
		<a href="${pageContext.request.contextPath}/main/shopbrandAction!addUI.action" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> 添     加  </a>
		...
		<div class="widget widget-2">
			...
			<div class="widget-body">
				...
				<table class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable">
					...
					<tbody>
					<s:iterator value="brands" status="stats">
																		<tr class="selectable">
							...
							<td class="center">
								<a href="${pageContext.request.contextPath}/main/shopbrandAction!editUI.action?id=${id}" class="btn-action glyphicons pencil btn-success"><i></i></a>
								<a href="${pageContext.request.contextPath}/main/shopbrandAction!delete.action?id=${id}"  onclick="return window.confirm('您确定要删除当前选中分类吗？')"  class="btn-action glyphicons remove_2 btn-danger"><i></i></a>
							</td>
						</tr>
						</s:iterator>					
