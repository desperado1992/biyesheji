...
<s:form action="shopbrandAction!%{id == null ? 'add' : 'edit'}"  id="shopform" >
		...
		<s:hidden name="id"></s:hidden>
			...
			<div class="tab-pane active" id="productDescriptionTab">
				<div class="row-fluid">
					<div class="span3">
						<strong>品牌名称</strong>
						<p class="muted">商品的新品牌.</p>
					</div>
					<div class="span9">
						<label for="inputEmail">品牌名</label>
				...
				<div class="row-fluid">
					<div class="span3">
						<strong>品牌介绍</strong>
						<p class="muted">商品品牌的介绍说明.</p>
					</div>
					<div class="span9">
						<label for="inputEmail">品牌说明</label>
